...
}, {"./entity":64,"bind":9,"./cookie":12,"debug":13,"inherit":65,"uuid":76}],
...
module.exports = {
  'attribution': require('analytics.js-integration-attribution')
};

}, {"analytics.js-integration-attribution":77}],
...
Attribution.prototype.send = function(path, msg, fn) {
  var projectId = this.options.project || this.analytics.projectId;
...
}, {"clone":11,"cookie":56,"extend":66,"analytics.js-integration":78,"segmentio/json@1.0.0":57,"store":79,"protocol":80,"send-json":81,"top-domain":82,"uuid":76}],
...
}, {"bind":83,"clone":11,"debug":84,"defaults":14,"extend":85,"slug":86,"./protos":87,"./statics":88}],
...
}, {"emitter":6,"after":8,"each":91,"analytics-events":92,"fmt":93,"foldl":94,"load-iframe":95,"load-script":96,"to-no-case":97,"next-tick":55,"every":98,"is":99}],
...
}, {"type":100,"component-type":100,"to-function":72}],
...
}, {"script-onload":101,"next-tick":55,"type":45}],
...
}, {"emitter":6,"domify":102,"each":91,"includes":68}],
...
}, {"base64-encode":104,"has-cors":105,"jsonp":106,"json":57}],
